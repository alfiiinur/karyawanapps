                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-2 p-2">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Tambah Point Pelangaran</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="/pelanggaran" method="POST">
                ...
                <div class="col my-3 flex-col my-3">
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden rounded">
                        ...
                        <select name="karyawan_id" id="" required>
                    ...
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden rounded">
                        ...
                        <input class="form-control hide-focus border-0" type="text" name="keterangan_pelanggaran"
                            placeholder="Masukkan Keterangan Pelangaran" required />

                    </div>
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden rounded">
                        <span class="input-group-text bg-white border-0 pe-1" id="basic-addon1">
                            <i class="bi bi-geo-alt" style="width:16px; height:16px;"></i>
                        </span>
                        <input class="form-control hide-focus border-0" type="number" name="point" min="0"
                            placeholder="Masukkan Point Pelanggaran" required />
                    </div>
                </div>
