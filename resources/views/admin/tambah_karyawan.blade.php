                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-2 p-2">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Tambah Karyawan</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="/karyawan" method="POST">
                ...
                <div class="col my-3 flex-col my-3">
                    ...
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden border">
                        ...
                        <input type="text" class="form-control hide-focus  border-0" placeholder="Masukkan Alamat"
                    ...
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden border">
                        ...
                        <input type="text" class="form-control hide-focus  border-0"
                            placeholder="Masukkan Nomor Telepon" aria-label="Username"
