                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-2 p-2">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Data Pelanggaran Karyawan</h1>
                            </div>
                            <!-- Actions -->
                            @if (Auth::user()->level == 'admin')
                                <div class="col-sm-6 col-12 text-sm-end">
                                    <div class="mx-n1">
                                        <a href="/pelanggaran/create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                            <span class=" pe-2">
                                                <i class="bi bi-plus"></i>
                                            </span>
                                            <span>Tambah Point Pelangaran</span>
                                        </a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <table class="table table-hover table-nowrap ">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Total Pelangaran</th>
                                ...
                                <tbody>
                                    @foreach ($pelanggaran as $key => $pel)
                                        <tr>
                                            ...
                                            @if (Auth::user()->level == 'admin')
                                                <td class="text-start">
                                                    <a href="/pelanggaran/{{ $pel->karyawan_id }}"
                                                        class="btn btn-success my-3">Detail</a>
