                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-2 p-2">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Absen</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('data.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col my-3 flex-col my-3">
                    ...
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden border">
                        <span class="input-group-text bg-white border-0 pe-1" id="basic-addon1">
                            <i class="bi bi-camera" style="width:16px; height:16px;"></i>
                        </span>
                        <input type="file" class="form-control hide-focus  border-0" placeholder="Masukkan Foto"
                            aria-label="Foto" aria-describedby="basic-addon1" name="foto">
                    </div>

                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden border">
                        <span class="input-group-text bg-white border-0 pe-1" id="basic-addon1">
                            <i class="bi bi-calendar" style="width:16px; height:16px;"></i>
                        </span>
                        <input type="date" class="form-control hide-focus  border-0"
                            placeholder="Masukkan Tanggal Masuk" aria-label="Username"
                            aria-describedby="basic-addon1" name="tanggal_masuk">
                    </div>
                    <div class="input-group mb-3 my-3 rounded-pill overflow-hidden rounded">
                        <span class="input-group-text bg-white border-0 pe-1" id="basic-addon1">
                            <i class="bi bi-inbox" style="width:16px; height:16px;"></i>
                        </span>
                        <textarea name="keterangan" id="" cols="130"class="form-control hide-focus  border-0"></textarea>
                    </div>
                </div>
